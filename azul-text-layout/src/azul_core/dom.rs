use super::{
    ...
    callbacks::{Callback, CallbackType, IFrameCallback, IFrameCallbackType, RefAny},
...
use crate::css::{Css, CssProperty, FontRef, NodeTypeTag};
use core::{
    fmt,
    hash::{Hash, Hasher},
    iter::FromIterator,
...
pub use super::id_tree::{Node, NodeHierarchy, NodeId};
...
macro_rules! parse_from_str {
    ($s:expr, $prop_type:ident) => {{
        use crate::css::{CssDeclaration, CssKeyMap};
        use crate::css_parser::ErrorLocation;
        ...
        let v = s
            ...
            .filter_map(|kv| {
                ...
                crate::css_parser::parse_css_declaration(
                    key,
                    value,
...
fn join_vec<T: Clone>(lhs: &[T], mut rhs: Vec<T>) -> Vec<T> {
    rhs.splice(0..0, lhs.iter().cloned());
    rhs
}
...
pub struct NodeData {
    ...
    pub(crate) inline_css_props: Vec<NodeDataInlineCssProperty>,
...
pub struct AccessibilityInfo {
    ...
    pub accelerator: Option<VirtualKeyCodeCombo>,
...
impl NodeData {
    ...
    #[inline(always)]
    pub fn get_dataset_mut(&mut self) -> &mut Option<RefAny> {
        &mut self.dataset
    }
    #[inline(always)]
    pub const fn get_dataset(&self) -> &Option<RefAny> {
        &self.dataset
    }
    #[inline(always)]
    pub const fn get_ids_and_classes(&self) -> &Vec<IdOrClass> {
        &self.ids_and_classes
    }
    #[inline(always)]
    pub const fn get_callbacks(&self) -> &Vec<CallbackData> {
        &self.callbacks
    }
    #[inline(always)]
    pub const fn get_inline_css_props(&self) -> &Vec<NodeDataInlineCssProperty> {
    ...
    #[inline(always)]
    pub fn set_dataset(&mut self, data: Option<RefAny>) {
        self.dataset = data;
    }
    #[inline(always)]
    pub fn set_ids_and_classes(&mut self, ids_and_classes: Vec<IdOrClass>) {
        self.ids_and_classes = ids_and_classes;
    }
    #[inline(always)]
    pub fn set_callbacks(&mut self, callbacks: Vec<CallbackData>) {
        self.callbacks = callbacks;
    }
    #[inline(always)]
    pub fn set_inline_css_props(&mut self, inline_css_props: Vec<NodeDataInlineCssProperty>) {
    ...
    #[inline]
    pub fn add_id(&mut self, s: String) {
        let mut v = Vec::new().into();
    ...
    #[inline]
    pub fn add_class(&mut self, s: String) {
        let mut v = Vec::new().into();
        mem::swap(&mut v, &mut self.ids_and_classes);
        let mut v = v.into_library_owned_vec();
    ...
    #[inline(always)]
    pub fn with_dataset(mut self, data: Option<RefAny>) -> Self {
        self.dataset = data;
        self
    }
    #[inline(always)]
    pub fn with_ids_and_classes(mut self, ids_and_classes: Vec<IdOrClass>) -> Self {
        self.ids_and_classes = ids_and_classes;
        self
    }
    #[inline(always)]
    pub fn with_callbacks(mut self, callbacks: Vec<CallbackData>) -> Self {
        self.callbacks = callbacks;
        self
    }
    #[inline(always)]
    pub fn with_inline_css_props(
        mut self,
        inline_css_props: Vec<NodeDataInlineCssProperty>,
    ) -> Self {
        self.inline_css_props = inline_css_props;
        self
    }
...
impl Dom {
    ...
    pub fn style(&mut self, css: crate::css_parser::CssApiWrapper) -> StyledDom {
        StyledDom::new(self, css)
    }
    #[inline(always)]
    pub fn with_children(mut self, children: Vec<Dom>) -> Self {
        self.children = children;
        self
    }
    #[inline(always)]
    ...
    pub fn set_inline_style(&mut self, style: &str) {
        self.root.set_inline_css_props(join_vec(
            self.root.get_inline_css_props(),
            NodeDataInlineCssProperty::parse_normal(style),
        ))
    }
...
//     let dom: Dom = (0..5).map(|e| NodeData::new(NodeType::Text(format!("{}", e + 1)))).collect();
//     let dom = convert_dom_into_compact_dom(dom);
...
//         node_type: NodeType::Text("5".to_string()),
//         .. Default::default()
//     }));
// }
