...
impl CssApiWrapper {
    ...
    pub fn from_string(s: String) -> Self {
        Self {
            css: crate::css_parser::new_from_str(s.as_str()).unwrap_or_default(),
        }
    }
}
...
fn test_css_pseudo_selector_parse() {
    ...
    use crate::css::CssNthChildPattern;
    use crate::css::CssNthChildSelector::*;
    let ok_res = [
        (("first", None), First),
        (("last", None), Last),
        (("hover", None), Hover),
...
///
/// ```rust
/// # extern crate crate::css;
/// # extern crate crate::css_parser;
/// # use crate::css_parser::parse_css_path;
/// # use crate::css::{
...
fn unparsed_css_blocks_to_stylesheet<'a>(
    ...
    let css_key_map = crate::css::get_css_key_map();
