use super::css::PrintAsCssValue;
use super::css_properties::*;
...
impl PrintAsCssValue for Vec<StyleFontFamily> {
    fn print_as_css_value(&self) -> String {
        self.iter()
            .map(|f| f.as_string())
            .collect::<Vec<_>>()
...
impl PrintAsCssValue for Vec<StyleFilter> {
    fn print_as_css_value(&self) -> String {
        self.iter()
...
impl PrintAsCssValue for Vec<StyleBackgroundContent> {
    fn print_as_css_value(&self) -> String {
        self.iter()
            .map(|f| f.print_as_css_value())
            .collect::<Vec<_>>()
...
impl PrintAsCssValue for Vec<StyleBackgroundPosition> {
    fn print_as_css_value(&self) -> String {
        self.iter()
            .map(|f| f.print_as_css_value())
            .collect::<Vec<_>>()
...
impl PrintAsCssValue for Vec<StyleBackgroundSize> {
    fn print_as_css_value(&self) -> String {
        self.iter()
            .map(|f| f.print_as_css_value())
            .collect::<Vec<_>>()
...
impl PrintAsCssValue for Vec<StyleBackgroundRepeat> {
    fn print_as_css_value(&self) -> String {
        self.iter()
            .map(|f| f.print_as_css_value())
            .collect::<Vec<_>>()
...
impl PrintAsCssValue for Vec<StyleTransform> {
    fn print_as_css_value(&self) -> String {
        self.iter()
            .map(|f| f.print_as_css_value())
            .collect::<Vec<_>>()
