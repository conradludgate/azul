...
impl CssProperty {
    ...
    pub const fn font_family(input: Vec<StyleFontFamily>) -> Self {
    ...
    pub const fn background_content(input: Vec<StyleBackgroundContent>) -> Self {
        CssProperty::BackgroundContent(CssPropertyValue::Exact(input))
    }
    pub const fn background_position(input: Vec<StyleBackgroundPosition>) -> Self {
        CssProperty::BackgroundPosition(CssPropertyValue::Exact(input))
    }
    pub const fn background_size(input: Vec<StyleBackgroundSize>) -> Self {
        CssProperty::BackgroundSize(CssPropertyValue::Exact(input))
    }
    pub const fn background_repeat(input: Vec<StyleBackgroundRepeat>) -> Self {
    ...
    pub const fn transform(input: Vec<StyleTransform>) -> Self {
